...
def parsing_args(c):
    ...
    if c.dataset == 'mvtec':
        ...
        setattr(c, 'data_path', 'F:/project_AD/dataset')
        ...
        from datasets import MIAD_CLASS_NAMES
        setattr(c, 'data_path', 'F:/project_AD/MIAD')
        if c.class_names == ['all']:
            setattr(c, 'class_names', MIAD_CLASS_NAMES)
